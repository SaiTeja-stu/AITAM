...
public final class PolicyContext {
    ...
    private final EmailMessage email;          // nullable (only for EMAIL with headers)
    ...
    public Optional<EmailMessage> email() { return Optional.ofNullable(email); }
    ...
    public static final class Builder {
        ...
        public Builder email(EmailMessage v) { this.email = v; return this; }
